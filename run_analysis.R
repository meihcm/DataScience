...
FULL_TEST_INERTIAL <- rbind(TEST_INERTIAL_BODY_ACCEL_X,TEST_INERTIAL_BODY_ACCEL_Y, TEST_INERTIAL_BODY_ACCEL_Z,TEST_INERTIAL_TOTAL_ACCEL_X,TEST_INERTIAL_TOTAL_ACCEL_Y,TEST_INERTIAL_TOTAL_ACCEL_Z)
...
setwd(PROJECT_HOME)
write.table(FULL_TEST_INERTIAL, file = "full_test_innertial.txt")
