...
PROJECT_HOME <- "/Users/michaelchiem/DataScience"
...
FEATURE_MAP <- read.table("features.txt", col.names = c("featureKey", "featureValues"), header=FALSE)
...
TEST_Y_DATA <- read.table("X_test.txt", col.names=c("labelKey"), header=FALSE)
